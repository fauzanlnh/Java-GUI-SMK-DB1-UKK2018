...
public class TambahPengguna extends javax.swing.JFrame {
    ...
    public void Simpan() {
        ...
        String no = txtUsername.getText();
        String perihal = txtPassword.getText();
        String tujuan = cmbLevel.getSelectedItem().toString();

        try {
    Statement stmt = koneksi.createStatement();
           
            String query = "insert into t_login values ('" + no + "', '" + perihal + "'"
                    + ",'" + tujuan + "')";
    ...
    private void initComponents() {
        ...
        cmbLevel.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-Pilih Salah Satu-", "Admin", "User" }));
