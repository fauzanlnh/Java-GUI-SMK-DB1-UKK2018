 ...
 * @author SMKN4
 */
public class ReportSuratKeluar extends javax.swing.JFrame {

    /**
     * Creates new form ReportSuratKeluar
     */
    Connection koneksi;

    public ReportSuratKeluar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Report Surat Keluar");
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        try {
            ...
            reportSource = System.getProperty("user.dir") + "/Report/ReportSuratKeluar.jrxml";
            reportDest = System.getProperty("user.dir") + "/Report/ReportSuratKeluar.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportSuratKeluar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReportSuratKeluar().setVisible(true);
            }
        });
    }
